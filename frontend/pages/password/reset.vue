...
<style scoped>
.reset-container { display:flex; height:100vh; width:100vw; overflow:hidden; }
.image-section { flex:0 0 50vw; }
...
.brand { margin-bottom:1rem; display:flex; justify-content:center; }
.title { font-size:1.25rem; font-weight:700; color:#111827; margin:.25rem 0; }
.subtitle { color:#6b7280; font-size:.95rem; margin-bottom:1rem; }
.form { display:flex; flex-direction:column; align-items:center; gap:.75rem; }
...
.button { width:75%; height:48px; background:#1f2937; color:#fff; font-weight:600; border:none; border-radius:8px; cursor:pointer; }
.button:disabled { background:#9ca3af; cursor:not-allowed; }
.success { color:#065f46; background:#d1fae5; border:1px solid #34d399; padding:.75rem; border-radius:.5rem; width:75%; margin:0 auto; }
.error { color:#B42318; background:#FEF3F2; border:1px solid #FEE4E2; padding:.75rem; border-radius:.5rem; width:75%; margin:0 auto; }
.back-link { display:block; margin-top:.75rem; color:#1f2937; text-decoration:none; }
